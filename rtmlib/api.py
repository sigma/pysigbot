...
API = {
    ...
    'tasks': {
        ...
        'addTags': (['timeline', 'list_id', 'taskseries_id', 'task_id', 'tags'],
                    []),
        ...
        'movePriority': (['timeline', 'list_id', 'taskseries_id',
                          'task_id', 'direction'], []),
        'moveTo': (['timeline', 'from_list_id', 'to_list_id',
                    'taskseries_id', 'task_id'], []),
        'postpone': (['timeline', 'list_id', 'taskseries_id', 'task_id'], []),
        'removeTags': (['timeline', 'list_id', 'taskseries_id',
                        'task_id', 'tags'], []),
        'setDueDate': (['timeline', 'list_id', 'taskseries_id', 'task_id'],
                       ['due', 'has_due_time', 'parse']),
        'setEstimate': (['timeline', 'list_id', 'taskseries_id', 'task_id'],
                        ['estimate']),
        'setLocation': (['timeline', 'list_id', 'taskseries_id', 'task_id'],
                        ['location_id']),
        'setName': (['timeline', 'list_id', 'taskseries_id', 'task_id', 'name'],
                    []),
        'setPriority': (['timeline', 'list_id', 'taskseries_id', 'task_id'],
                        ['priority']),
        'setRecurrence': (['timeline', 'list_id', 'taskseries_id', 'task_id'],
                          ['repeat']),
